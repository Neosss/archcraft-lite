...
# Web seed urls
WEB_SEED=(https://github.com/archcraft-os/archcraft-lite/releases/download/${TAG}/${RELEASE}
		  https://github.com/archcraft-os/archcraft-lite/releases/download/${TAG}/${RELEASE}.sha256sum
		  https://github.com/archcraft-os/archcraft-lite/releases/download/${TAG}/${RELEASE}.sig
)
